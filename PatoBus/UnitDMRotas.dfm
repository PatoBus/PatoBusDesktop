object DMRotas: TDMRotas
  ...
  object QRotasCombobox: TFDQuery
    Connection = FormConnection.FDConnection1
    SQL.Strings = (
      'Select * from rota')
    Left = 560
    Top = 232
    object QRotasComboboxid_rota: TLargeintField
      AutoGenerateValue = arAutoInc
      FieldName = 'id_rota'
      Origin = 'id_rota'
      ProviderFlags = [pfInWhere, pfInKey]
    end
    object QRotasComboboxdescricao: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'descricao'
      Origin = 'descricao'
      Size = 255
    end
    object QRotasComboboxnome_rota: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'nome_rota'
      Origin = 'nome_rota'
      Size = 255
    end
    object QRotasComboboxpontos: TMemoField
      AutoGenerateValue = arDefault
      FieldName = 'pontos'
      Origin = 'pontos'
      BlobType = ftMemo
    end
    object QRotasComboboxid_linha: TLargeintField
      FieldName = 'id_linha'
      Origin = 'id_linha'
      Required = True
    end
    object QRotasComboboxid_empresa: TLargeintField
      FieldName = 'id_empresa'
      Origin = 'id_empresa'
      Required = True
    end
  end
  object DSRotasCombobox: TDataSource
    DataSet = QRotasCombobox
    Left = 560
    Top = 296
  end
end
